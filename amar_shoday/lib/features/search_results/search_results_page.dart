...
class SearchResultsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TextEditingController searchController =
        TextEditingController(); // removed initial text

    // Split products into rows of 3 to ensure equal layout
              ...
              children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              hintText:
                                  'Search by product, brand', // placeholder text
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text(
                        '"$searchQuery"', // double quotes around query
